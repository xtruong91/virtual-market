    ...
    public static class Extensions
    {
        ...
        public static void AddRabbitMq(this ContainerBuilder builder)
        {
            ...
            builder.RegisterType<BusPublisher>().As<IBusPublisher>()
                .InstancePerDependency();
            builder.RegisterInstance(VirtualMarketDefaultTracer.Create()).As<ITracer>().SingleInstance()
        ...
        private static void ConfigureBus(ContainerBuilder builder)
        {
            builder.Register<IInstanceFactory>(context =>
            {
                ...
                var namingConventions = new CustomNamingConvention(options.Namespace);
        ...
        private class CustomNamingConvention : NamingConventions
        {
            public CustomNamingConvention(string defaultNamespace)
            {
        ...
        private class RetryStageMiddleware : StagedMiddleware
        {
        ...
        {          
            clientBuilder.Register(c => c.Use<RetryStageMiddleware>());
